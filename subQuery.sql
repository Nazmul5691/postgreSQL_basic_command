...
INSERT INTO employees (employee_name, department_name, salary, hire_date) VALUES
    ('Jhon Doe', 'HR', 60000.00, '2022-01-10'),
...
SELECT max(salary) FROM employees WHERE department_name = 'HR'   --first find the highest salary of hr department

-- SCALAR SUBQUERY   - ONLY ONE DATA RETURN
